...
- HOST_DOMAIN - Domain/sub-domain of your application, eg `eapp.example.com` .
...
gh secret set AWS_ECS_CLUSTER -b"<AWS_ECS_CLUSTER, eg eapps>"
gh secret set HOST_DOMAIN -b"<HOST_DOMAIN, eg eapp.example.com>"
